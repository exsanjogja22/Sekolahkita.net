...
import '../controllers/alamat_asli_controller.dart';

class AlamatAsliView extends GetView<AlamatAsliController> {
  const AlamatAsliView({Key? key}) : super(key: key);
  @override
          ...
          children: [
            Container(
              ...
              child: Row(mainAxisSize: MainAxisSize.max, children: [
                GetBuilder<AlamatAsliController>(builder: (_) {
