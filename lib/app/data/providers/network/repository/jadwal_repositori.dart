...
class JadwalRepositori extends EnpointRepository {
  Future<ResponseApi?> getJadwal() async {
    final auth = await apiAuth.getToken();
    final response = await apiRepository.getMetod(PathAPIEndpoint.jadwal, auth);
    if (response != null) {
